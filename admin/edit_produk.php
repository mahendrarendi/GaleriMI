                           ...
                           <div class="full">
                              <form action="" method="POST" enctype="multipart/form-data">
                                 <fieldset>
                                    ...
                                    <select class="custom-select custom-select-lg mb-3" id="" name="" style="font-size: 16px; border-radius:8px;">
                                    ...
                                    <input type="file" name="foto_produk" value="" required />
                                    <label><b>Link Produk</b></label>
                                    <input type="text" name="link_produk" value="" required />
                                    ...
                                    <input type="text" name="deskripsi_produk" value="" required />
