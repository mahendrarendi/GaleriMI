         ...
         <div class="row d-flex d-md-block flex-nowrap wrapper">
            <div class="col-md-3 float-left col-1 pl-0 pr-0 collapse width show" id="sidebar">
               <div class="list-group border-0 text-center text-md-left">
                  <a href="dashboard_admin.php" class="list-group-item d-inline-block collapsed" data-parent="#sidebar"><i class="fa fa-dashboard"></i> <span class="d-none d-md-inline">Dashboard</span></a>
            ...
            <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
               <div class="detail-box">
                  ...
                  <div class="float-right pb-3">
                     <a href="tambah_kategori.php"><button class="add-setting"><i class="fa fa-plus fa-lg"></i> <b>Tambah</b></button></a>
                  </div>
               </div>
               <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td>
                           <a href="edit_kategori.php"><button class="edit-setting"><i class="fa fa-pencil fa-lg"></i></button></a>
                           <a href=""><button class="delete-setting"><i class="fa fa-trash fa-lg"></i></button></a>
                        </td>
                     </tr>
                     <tr>
                        <th scope="row">2</th>
