                ...
                <main class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
                    <div class="detail-box">
                        ...
                        <div class="float-right pb-3">
                            <a href="tambah_produk.php"><button class="add-setting"><i class="fa fa-plus fa-lg"></i> <b>Tambah</b></button></a>
                        </div>
                    </div>
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_produk.php"><button class="edit-setting"><i class="fa fa-pencil fa-lg"></i></button></a>
